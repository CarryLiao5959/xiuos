...
* Version         : V1.0
* Date            : 2017-8-25
* Description     : Operate the register functions of LT768
				   See the LT768.h file for details on which registers to operate
*********************************************************/
...
*/
	...
	LCD_CmdWrite(0x12);
	temp = LCD_DataRead();
        rt_kprintf("Display_ON.pre_read=%02x\n",temp);
	temp |= cSetb6;
	LCD_DataWrite(temp);
	    temp = LCD_DataRead();
	    rt_kprintf("Display_ON.write_read=%02x\n",temp);
