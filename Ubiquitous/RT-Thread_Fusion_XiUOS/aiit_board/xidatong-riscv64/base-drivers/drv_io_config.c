...
#endif
    // Add LT768
    IOCONFIG(BSP_LCD_MISO,  HS_GPIO(FPIOA_LCD_MISO)),
    IOCONFIG(BSP_LCD_MOSI,  HS_GPIO(FPIOA_LCD_MOSI)),
    IOCONFIG(BSP_LCD_SCLK,  HS_GPIO(FPIOA_LCD_SCLK)),
    IOCONFIG(BSP_LCD_NCS,  HS_GPIO(FPIOA_LCD_NCS)),
    IOCONFIG(BSP_LCD_NRST,  HS_GPIO(FPIOA_LCD_NRST)),
    IOCONFIG(BSP_LCD_BL_PIN,  HS_GPIO(FPIOA_LCD_BL)),
#endif
...
#endif
#ifdef BSP_USING_CAN
    IOCONFIG(BSP_CAN_NCFG_PIN,  HS_GPIO(FPIOA_CAN_NCFG)), 
#endif
